...
> **현재 상태: PR5 (Hooks v2)**. PreToolUse 6종 + SessionStart/Stop 훅, Skills 시스템, project-ops (MCP github + gh fallback), native worktree 격리. 자세한 설계는 [`multi-agent-pipeline-best-practices.md`](./multi-agent-pipeline-best-practices.md), 2026년 베스트 프랙티스 분석은 PR1 커밋 메시지 참조.
